public class Second {
    public static void main(String[] args) {
        ...
        System.out.println(fullName("Angelina", "Petuhhova"));
    ...
    public static void areStringsEqual(){
        ...
        String newName1 = new String("Angelina"); // new object
        String newName2 = new String("Angelina");
